...
import { downloadSalesBreakdown } from "@/features/dashboard/libs/xlsx";
...
const SalesBreakdownTable = <TData, TValue>({
  columns,
  data,
  ...
  const totalSellingProducts = data.length;
    ...
    <div>
      ...
      <div className="rounded-t-md border-t border-x">
        <div className="flex flex-wrap md:flex-row justify-between items-center px-2 border-b">
          ...
          <Button onClick={() => downloadSalesBreakdown()} className="my-4">
            Export to Excel
          </Button>
        </div>
        <Table>
            ...
            <TableRow>
              <TableCell colSpan={columns.length}>
                <div className="flex justify-between">
                  ...
                  <span>Total Selling Products: {totalSellingProducts}</span>
                </div>
              </TableCell>
            </TableRow>
          </TableFooter>

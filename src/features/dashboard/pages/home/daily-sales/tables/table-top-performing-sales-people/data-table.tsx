...
import { downloadTopPerformingSalesPeople } from "@/features/dashboard/libs/xlsx";
...
const TopPerformingSalesPeopleTable = <TData, TValue>({
  columns,
  data,
  ...
  const averageTransactionValue = data.reduce(
    (sum, item) =>
      sum +
      // item.total ||
      0,
  ...
  const topSalesPerson = data.length;
      ...
      <div className="rounded-t-md border-t border-x">
        <div className="flex flex-wrap md:flex-row justify-between items-center px-2 border-b">
          <Input
            ...
            value={
              (table.getColumn("sales_person")?.getFilterValue() as string) ??
              ""
            }
            onChange={(event) => {
              table
                .getColumn("sales_person")
          ...
          <Button
            onClick={() => downloadTopPerformingSalesPeople()}
            className="my-4"
          >
            Export to Excel
          </Button>
            ...
            <TableRow>
              <TableCell colSpan={columns.length}>
                <div className="flex justify-between">
                  ...
                  <span>Top Sales Person: {topSalesPerson}</span>
                </div>
              </TableCell>
            </TableRow>
          </TableFooter>
...
export default TopPerformingSalesPeopleTable;

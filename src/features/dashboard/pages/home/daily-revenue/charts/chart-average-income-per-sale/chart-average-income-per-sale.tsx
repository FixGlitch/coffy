...
interface ChartAverageIncomeState {
  series: number[];
}
...
export default function ChartAverageIncome() {
  const [state, setState] = useState<ChartAverageIncomeState>({
    series: [55, 45],
  });
  ...
  return (
    <div className="rounded-sm border border-coffee-400 bg-coffee-50 px-5 pt-7.5 pb-5 shadow-default">
      ...
      <div className="mb-2">
        <div id="chartAverageIncome" className="mx-auto flex justify-center">

...
interface ChartStarProductState {
  series: number[];
}
...
export default function ChartStarProduct() {
  const [state, setState] = useState<ChartStarProductState>({
    series: [85, 15],
  });
  ...
  return (
    <div className="rounded-sm border border-coffee-400 bg-coffee-50 max-w-full px-5 pt-7.5 pb-5 shadow-default">
      ...
      <div className="mb-2">
        <div id="chartStarProduct" className="mx-auto flex justify-center">

...
export default function ChartThree() {
  ...
  return (
    <div className="col-span-12 rounded-sm border border-black dark:border-white bg-white dark:bg-black  px-5 pt-7.5 pb-5 shadow-default sm:px-7.5 xl:col-span-5">
